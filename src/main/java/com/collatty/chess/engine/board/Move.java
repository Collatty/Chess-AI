...
import com.collatty.chess.engine.pieces.Pawn;
...
public abstract class Move {
    ...
    public boolean equals (final Object other) {
        ...
        return getCurrentCoordinate() ==
                otherMove.getCurrentCoordinate() && getDestinationCoordinate() == otherMove.getDestinationCoordinate() &&
    ...
    static abstract class CastleMove extends Move {
        ...
        public Board execute() {
            ...
            builder.setPiece(this.movedPiece.movePiece(this));
            builder.setPiece(new Rook(this.castleRook.getPieceAlliance(), this.castleRookDestination)); //TODo look
            // into first move
            builder.setMoveMaker(this.board.currentPlayer().getOpponent().getAlliance());
            return builder.build();
        }
